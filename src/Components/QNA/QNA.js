...
// QNA SECTION WHICH PROVIDE YOU ANSWERS OF FREQUENTLY ASKED QUESTION RELATED TO OUR WEBSITE AND PRODUCTS
const useStyles = makeStyles(() => ({
  // STYLES FOR CONTENT SHOWING ON QNA PAGE
  root: {
    width: "100%",
  },
  heading: {
  ...
  return (
    <div className={classes.root}>
      ...
      <Accordion>
        ...
        >
          <Typography className={classes.heading}>
            Does M&N Fashion Provide any Discounts on products ?
          </Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
